  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`relative z-10 bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl overflow-hidden w-full shadow-2xl ${
                ...
                {images.map((img, idx) => (
                  <motion.button
                    ...
                    className={`relative flex-shrink-0 w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden border-2 transition-all duration-300 ${
                      idx === currentImageIndex ? 'border-blue-500 shadow-lg shadow-blue-500/50' : 'border-gray-600 hover:border-gray-400'
                    }`}
                  >
