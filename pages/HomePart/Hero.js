          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12 xl:gap-16">
            ...
            >
              ...
              >
                ...
                <button className="px-5 py-2.5 md:px-6 md:py-3 bg-white/5 backdrop-blur-md text-white font-semibold rounded-xl border-2 border-white/20 hover:bg-white/10 hover:border-blue-400/50 hover:-translate-y-1 transition-all duration-300 flex items-center gap-2 text-xs md:text-sm">
                  <FaDownload size={14} />
                  Download CV
                </button>
              </motion.div>
